        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                <div class="class mb-5"role="alert">
                    <div class="class bg-red-500 text-white font-bold rounded-t px-4 py-2">
                        There Something Wrong!
                    </div>
                    <div class="class border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
                        <p>
                            <ul>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input value="{{ old("desciption") ?? $item->description }}" name="description" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Food Description">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                    ...
                    <p class="text-gray-600 text-xs italic">Dipisahkan Dengan Koma, Cth:Bawang Merah, Tomat, Micin, Timun, Sayur</p>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input value="{{ old("types") ?? $item-> types }}" name="types" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Food Type">                   
                        <p class="text-gray-600 text-xs italic">Dipisahkan Dengan Koma, Cth: popular, recommended, new_food</p>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
